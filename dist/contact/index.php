...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WBLZ3KD" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  ...
  <div class="wrapper">
    <header class="header">
      <div class="header__inner">
        ...
        <div class="header__burger" data-burger-button>
          ...
          <?php else : ?>
            ...
            <form action="" method="post">
              <div class="mail__item">
                ...
                <input class="mail__input" type="text" name="your_name" value="<?php if (!empty($clean['your_name'])) {
              ...
              <div class="mail__item">
                ...
                <input class="mail__input" type="text" name="email" value="<?php if (!empty($clean['email'])) {
                                                                              echo $clean['email'];
              ...
              <div class="mail__item">
                ...
                <input class="mail__input" type="tel" name="tel" value="<?php if (!empty($clean['tel'])) {
                                                                          echo $clean['tel'];
              ...
              <div class="mail__item">
                ...
                <textarea class="mail__txtarea" name="contact" placeholder="お問合わせ内容をご入力ください。"><?php if (!empty($_POST['contact'])) {
                                                                                                echo $_POST['contact'];
                                                                                              } ?></textarea>
              </div>
    ...
    <div class="pagetop" data-scroll-to-top-button>
